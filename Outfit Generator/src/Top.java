...
public Top (String name, User user) {
	super(name, user);
}
public Top(User user, String name, String description, boolean[] ranges, boolean clean, String patterned, boolean denim,
...
public String toStringSave() {
	...
	s += "Score: " + getScore();
	System.out.println("Score being saved: " + getScore());
	return s;
}
}
